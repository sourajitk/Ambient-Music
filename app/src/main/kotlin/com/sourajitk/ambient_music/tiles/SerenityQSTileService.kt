...
class SerenityQSTileService : TileService() {

    companion object {
        private const val TAG = "SerenityTileService"
    }

    private val myGenre = "Serenity"
    ...
    override fun onStartListening() {
        ...
        Log.d(TAG, "Serenity Tile: Start")
        updateTileVisualsBasedOnServiceState()
    }

    override fun onStopListening() {
        super.onStopListening()
        Log.d(TAG, "Serenity Tile: Stop")
    }
    ...
    override fun onClick() {
        ...
        if (isMyGenreActiveNow) {
            ...
            val intent =
                Intent(this, MusicPlaybackService::class.java).apply {
                    action = MusicPlaybackService.ACTION_PLAY_GENRE_SERENITY
                }
            startForegroundService(intent)
        }
    }
    ...
    private fun applyVisuals(isMyGenreActive: Boolean, forceUnavailable: Boolean) {
        ...
        tile.label = getString(R.string.tile_label_serenity)
        if (forceUnavailable) {
            ...
            if (isMyGenreActive) {
                ...
                tile.icon = Icon.createWithResource(this, R.drawable.ic_serenity)
            } else {
