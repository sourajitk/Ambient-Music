...
class FocusQSTileService : TileService() {

  companion object {
    private const val TAG = "FocusQSTileService"
  }

  private val myGenre = "focus"
  ...
  override fun onStartListening() {
    ...
    Log.d(TAG, "Focus Tile: Start")
    updateTileVisualsBasedOnServiceState()
  }

  override fun onStopListening() {
    super.onStopListening()
    Log.d(TAG, "Focus Tile: Stop")
  }
  ...
  private fun applyVisuals(isMyGenreActive: Boolean, forceUnavailable: Boolean) {
    ...
    tile.label = getString(R.string.tile_label_focus)
    if (forceUnavailable) {
      ...
      if (isMyGenreActive) {
        ...
        tile.icon = Icon.createWithResource(this, R.drawable.ic_focus)
      } else {
